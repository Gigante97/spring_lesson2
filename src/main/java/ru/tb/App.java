...
import ru.tb.configs.AppConfig;
import ru.tb.products.Cart;
import ru.tb.products.Product;
import ru.tb.service.CartServiceImpl;
import ru.tb.service.ProductService;
...
public class App {
    ...
    public App(ProductService productService, CartServiceImpl cartService) {
